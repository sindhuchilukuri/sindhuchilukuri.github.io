  ...
  <div class="write1">
      ...
      <div class="dropdown-content3">
        ...
        <section class="read">
            ...
            <div class="row1">
                <div class="column1">
                  <img src="romance/1.jpg"  style="width:90%;border-radius: 10%;" id="myBtn">
                </div>
                <div class="column1">
                  <img src="romance/9.jpg"  style="width:90% ;border-radius: 10%" id="myBtn1">
                </div>
                <div class="column1">
                  <img src="romance/3.jpg"  style="width:90% ;border-radius: 10%" id="myBtn2">
                  
                </div>
                <div class="column1">
                  <img src="romance/4.jpg"  style="width:90% ;border-radius: 10%" id="myBtn3">
                </div>
                <div class="column1">
                  <img src="romance/5.jpg"  style="width:90%;border-radius: 10%" id="myBtn4">
                </div>
            </div>   
            <br>
            ...
            <div class="row4">
                <div class="column4">
                    <img src="romance/4.jpg"  style="width:90% ;border-radius:10%" id="myBtn6">
                  </div>
                  <div class="column4">
                    <h2 style="color:white;font-weight: normal;font-style:italic">
                      Probably the best kiss world.
                     </br>
                    Pernille Hughes</br>
                      </h2>        
                  ...
                  <div class="column4">
                    <img src="romance/6.jpg"  style="width:90% ;border-radius:10%" id="myBtn5">
                  </div>
                  <div class="column4">
                    <h2 style="color:white;font-weight: normal;font-style:italic">
                     Sailing Lessons
            ...
            <div class="row4">
              <div class="column4">
                  <img src="romance/7.jpg"  style="width:90% ;border-radius:10%" id="myBtn7">
                </div>
                <div class="column4">
                  <h2 style="color:white;font-weight: normal;font-style:italic">
                ...
                <div class="column4">
                  <img src="romance/8.jpg"  style="width:90% ;border-radius:10%" id="myBtn8">
                </div>
                <div class="column4">
                  <h2 style="color:white;font-weight: normal;font-style:italic">
                    ColdHearted Boss
          ...
          <div class="row4">
            <div class="column4">
                <img src="romance/9.jpg"  style="width:90% ;border-radius:10%" id="myBtn9">
              </div>
              <div class="column4">
                <h2 style="color:white;font-weight: normal;font-style:italic">
                  Michael Love and Space Blumlein
              ...
              <div class="column4">
                <img src="romance/10.jpg"  style="width:90% ;border-radius:10%" id="myBtn10">
              </div>
              <div class="column4">
                <h2 style="color:white;font-weight: normal;font-style:italic">
                  A star is born
            ...
            <marquee>
                    <img src="romance/1.jpg" height="260px" width="260px" >
                    </img><img src="romance/9.jpg" height="260px" width="260px">
                    </img>
                    <img src="romance/3.jpg" height="260px" width="260px" >
                    </img>
                    
                    <img src="romance/4.jpg" height="260px" width="260px" >
                    </img>
                    <img src="romance/5.jpg" height="260px" width="260px" >
                    </img>
                    <img src="romance/6.jpg" height="260px" width="260px" >
                    </img>
                    </marquee>
            ...
            <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="column5">
                        ...
                        <img id="myImg" src="romance/5.jpg"alt="Snow" style="width:100%">
...
<span class="fa fa-star"></span>        
                                ...
                                <p class="des">They had nothing in common until love gave them everything to lose . . .
                       </br>
                    ...
                    A Love Story for this generation and perfect for fans of John Green’s The Fault in Our Stars, Me Before You brings to life two people who couldn’t have less in common—a heartbreakingly romantic novel that asks, What do you do when making the person you love happy also means breaking your own heart?..........</p>
                       </div>
                       </div>
