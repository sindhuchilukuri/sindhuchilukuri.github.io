...
<a href="about.php" class="active">ABOUT</a>
        ...
        <div class="write1">
          ...
          <div class="column2">
              <img src="ski.gif" style="width:200px;height:200px;">
        ...
        <section class="read">
            ...
            <div class="row1">
                <div class="column1">
                  <img src="scifi/1.jpg"  style="width:90%;border-radius: 10%;" id="myBtn">
                </div>
                <div class="column1">
                  <img src="scifi/2.jpg"  style="width:90% ;border-radius: 10%" id="myBtn1">
                </div>
                <div class="column1">
                  <img src="scifi/3.jpg"  style="width:90% ;border-radius: 10%" id="myBtn2">
                  
                </div>
                <div class="column1">
                  <img src="scifi/4.jpg"  style="width:90% ;border-radius: 10%" id="myBtn3">
                </div>
                <div class="column1">
                  <img src="scifi/5.jpg"  style="width:90%;border-radius: 10%" id="myBtn4">
                </div>
            </div>   
            <br>
            ...
            <div class="row4">
                <div class="column4">
                    <img src="scifi/4.jpg"  style="width:90% ;border-radius:10%" id="myBtn6">
                  </div>
                  <div class="column4">
                  ...
                  <div class="column4">
                    <img src="scifi/3.jpg"  style="width:90% ;border-radius:10%" id="myBtn5">
                  </div>
                  <div class="column4">
                    <h2 style="color:white;font-weight: normal;font-style:italic">
                      Red Rising
            ...
            <div class="row4">
              <div class="column4">
                  <img src="scifi/1.jpg"  style="width:90% ;border-radius:10%" id="myBtn7">
                </div>
                <div class="column4">
                  <h2 style="color:white;font-weight: normal;font-style:italic">
                    The Time Machine
                ...
                <div class="column4">
                  <img src="scifi/6.jpg"  style="width:90% ;border-radius:10%" id="myBtn8">
                </div>
                <div class="column4">
                  <h2 style="color:white;font-weight: normal;font-style:italic">
...
The Butlerian Jihad
          ...
          <div class="row4">
            <div class="column4">
                <img src="scifi/2.jpg"  style="width:90% ;border-radius:10%" id="myBtn9">
              </div>
              <div class="column4">
                <h2 style="color:white;font-weight: normal;font-style:italic">
                  A Wrinkle in Time
              ...
              <div class="column4">
                <img src="scifi/4.jpg"  style="width:90% ;border-radius:10%" id="myBtn10">
              </div>
              <div class="column4">
                <h2 style="color:white;font-weight: normal;font-style:italic">
                  Snow Crash
            ...
            <marquee>
                    <img src="scifi/1.jpg" height="260px" width="260px" >
                    </img><img src="scifi/2.jpg" height="260px" width="260px">
                    </img>
                    <img src="scifi/3.jpg" height="260px" width="260px" >
                    </img>
                    
                    <img src="scifi/4.jpg" height="260px" width="260px" >
                    </img>
                    <img src="scifi/5.jpg" height="260px" width="260px" >
                    </img>
                    <img src="scifi/6.jpg" height="260px" width="260px" >
                    </img>
                    </marquee>
            ...
            <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="column5">
                        ...
                        <img id="myImg" src="scifi/2.jpg"alt="Snow" style="width:100%">
                        <button class="button" style="width:37.5%">Read.</button>
                       </div>
                       <div class="column3">
                              
                                      <span class="close">&times;</span>
                        <h2>A Wrinkle in Time</br>
                                </br>
                                



 Madeleine L'Engle</h2>        
                                <span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star"></span>        
                                            ...
                                            <span>5,854 rating</span>
                                            <span>664 reviews</span>
                                        
                                <p class="des" style="font-size:100%">It was a dark and stormy night.
                       </br>
                       ...
                       Winner of the 1963 Newbery Medal, A Wrinkle in Time is the first book in Madeleine L'Engle's classic Time Quintet...........</p>
                       </div>
                       </div>
