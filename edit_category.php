...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Forum </a> <?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?> &gt; Edit the category
    </div>
	<div class="box_right">
...
<form action="edit_category.php?id=<?php echo $id; ?>" method="post">
	...
	<br><label for="description">Description</label>(html enabled)<br />
    <br><textarea name="description" id="description" cols="70" rows="6"><?php echo htmlentities($dn1['description'], ENT_QUOTES, 'UTF-8'); ?></textarea><br />
