...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Forum</a> <a href="list_topics.php?parent=<?php echo $id; ?>"><?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?></a>  New Topic
    </div>
	<div class="box_right">
...
<form action="new_topic.php?parent=<?php echo $id; ?>" method="post">
	<br><label for="title">Title</label><input type="text" name="title" id="title"  /><br />
