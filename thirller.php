  ...
  <div class="write1">
      ...
      <div class="dropdown-content3">
        ...
        <section class="read">
            ...
            <div class="row1">
                <div class="column1">
                  <img src="thirller/1.jpg"  style="width:90%;border-radius: 10%;" id="myBtn">
                </div>
                <div class="column1">
                  <img src="thirller/2.jpg"  style="width:90% ;border-radius: 10%" id="myBtn1">
                </div>
                <div class="column1">
                  <img src="thirller/3.jpg"  style="width:90% ;border-radius: 10%" id="myBtn2">
                  
                </div>
                <div class="column1">
                  <img src="thirller/4.jpg"  style="width:90% ;border-radius: 10%" id="myBtn3">
                </div>
                <div class="column1">
                  <img src="thirller/5.jpg"  style="width:90%;border-radius: 10%" id="myBtn4">
                </div>
            </div>   
            <br>
            ...
            <div class="row4">
                <div class="column4">
                    <img src="thirller/4.jpg"  style="width:90% ;border-radius:10%" id="myBtn6">
                  </div>
                  <div class="column4">
                  ...
                  <div class="column4">
                    <img src="thirller/6.jpg"  style="width:90% ;border-radius:10%" id="myBtn5">
                  </div>
                  <div class="column4">
                    <h2 style="color:white;font-weight: normal;font-style:italic">
                      Killing FLoor
            ...
            <div class="row4">
              <div class="column4">
                  <img src="thirller/7.jpg"  style="width:90% ;border-radius:10%" id="myBtn7">
                </div>
                <div class="column4">
                  <h2 style="color:white;font-weight: normal;font-style:italic">
                   The Wife Between Us
                ...
                <div class="column4">
                  <img src="thirller/8.jpg"  style="width:90% ;border-radius:10%" id="myBtn8">
                </div>
                <div class="column4">
                  <h2 style="color:white;font-weight: normal;font-style:italic">
                  The Good  Girl
                   ...
                   Mary Kubica</br>
                    ...
                    <span class="fa fa-star"></span>        
                            ...
                            </br>    <li style="color:white">450 Reviews</li></table>
          ...
          <div class="row4">
            <div class="column4">
                <img src="thirller/9.jpg"  style="width:90% ;border-radius:10%" id="myBtn9">
              </div>
              <div class="column4">
                <h2 style="color:white;font-weight: normal;font-style:italic">
                  Rebecca<br>
              ...
              <div class="column4">
                <img src="thirller/10.jpg"  style="width:90% ;border-radius:10%" id="myBtn10">
              </div>
              <div class="column4">
                <h2 style="color:white;font-weight: normal;font-style:italic">
                  The Alienist.
            ...
            <marquee>
                    <img src="thirller/1.jpg" height="260px" width="260px" >
                    </img><img src="thirller/2.jpg" height="260px" width="260px">
                    </img>
                    <img src="thirller/3.jpg" height="260px" width="260px" >
                    </img>
                    
                    <img src="thirller/4.jpg" height="260px" width="260px" >
                    </img>
                    <img src="thirller/5.jpg" height="260px" width="260px" >
                    </img>
                    <img src="thirller/6.jpg" height="260px" width="260px" >
                    </img>
                    </marquee>
            ...
            <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="column5">
                        ...
                        <img id="myImg" src="thirller/1.jpg"alt="Snow" style="width:100%">
...
<span class="fa fa-star"></span>        
                                ...
                                <p class="des" style="font-size:100%">Two brothers meet at the border of their vast cattle properties under the unrelenting sun of outback Queensland, in this stunning new standalone novel from New York Times bestseller Jane Harper
