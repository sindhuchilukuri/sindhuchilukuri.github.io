...
<a href="about.php" class="active">ABOUT</a>
  ...
  <div class="write1">
      ...
      <div class="dropdown-content3">
          ...
          <br>
            <p class="read1">
                ...
                fantasy comprises works by many writers, artists, filmmakers, and musicians, from ancient myths and legends to many recent works embraced by a wide audience today, including young adults, most of whom are represented by the works below..
          </p>
            <br>
        ...
        <section class="read">
            ...
            <div class="row1">
                <div class="column1">
                  <img src="fantasy/1.jpg"  style="width:90%;border-radius: 10%;" id="myBtn">
                </div>
                <div class="column1">
                  <img src="fantasy/2.jpg"  style="width:90% ;border-radius: 10%" id="myBtn1">
                </div>
                <div class="column1">
                  <img src="fantasy/3.jpg"  style="width:90% ;border-radius: 10%" id="myBtn2">
                  
                </div>
                <div class="column1">
                  <img src="fantasy/4.jpg"  style="width:90% ;border-radius: 10%" id="myBtn3">
                </div>
                <div class="column1">
                  <img src="fantasy/5.jpg"  style="width:90%;border-radius: 10%" id="myBtn4">
                </div>
            </div>   
            <br>
            ...
            <div class="row4">
                <div class="column4">
                    <img src="fantasy/4.jpg"  style="width:90% ;border-radius:10%" id="myBtn6">
                  </div>
                  <div class="column4">
                  ...
                  <div class="column4">
                    <img src="fantasy/6.jpg"  style="width:90% ;border-radius:10%" id="myBtn5">
                  </div>
                  <div class="column4">
                    <h2 style="color:white;font-weight: normal;font-style:italic">
                      A Game of Thrones
   ...
   George R.R. Martin</br>
            ...
            <div class="row4">
              <div class="column4">
                  <img src="fantasy/7.jpg"  style="width:90% ;border-radius:10%" id="myBtn7">
                </div>
                <div class="column4">
                  <h2 style="color:white;font-weight: normal;font-style:italic">
                    Tigana
                ...
                <div class="column4">
                  <img src="fantasy/8.jpg"  style="width:90% ;border-radius:10%" id="myBtn8">
                </div>
                <div class="column4">
                  <h2 style="color:white;font-weight: normal;font-style:italic">
          ...
          <div class="row4">
            <div class="column4">
                <img src="fantasy/9.jfif"  style="width:90% ;border-radius:10%" id="myBtn9">
              </div>
              <div class="column4">
                <h2 style="color:white;font-weight: normal;font-style:italic">
                 THE GAME OF THRONES
            ...
            <marquee>
                    <img src="fantasy/8.jpg" height="260px" width="260px" >
                    </img><img src="fantasy/2.jpg" height="260px" width="260px">
                    </img>
                    <img src="fantasy/3.jpg" height="260px" width="260px" >
                    </img>
                    
                    <img src="fantasy/4.jpg" height="260px" width="260px" >
                    </img>
                    <img src="fantasy/5.jpg" height="260px" width="260px" >
                    </img>
                    <img src="fantasy/6.jpg" height="260px" width="260px" >
                    </img>
                    </marquee>
            ...
            <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="column5">
                        ...
                        <img id="myImg" src="fantasy/4.jpg"alt="Snow" style="width:100%">
                        <button class="button" style="width:37.5%">Read.</button>
                       </div>
                       <div class="column3">
                              
                                      <span class="close">&times;</span>
                        <h2> The Lies of Locke Lamora</br>
